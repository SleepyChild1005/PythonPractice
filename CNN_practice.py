...
from custom_util.custom_class import Net
# loading dataset
...
print('accuracy_train: ',accuracy_score(train_y, predictions))
...
print('accuracy_validation: ',accuracy_score(val_y, predictions))
